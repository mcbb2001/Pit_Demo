...
import PurePursuit.MathFunctions;

import static com.company.Robot.worldAngle_rad;
import static PurePursuit.MathFunctions.angleWrap;
...
public class SpeedOmeter {
    ...
    public static void update(){
        ...
        if(currTime - lastUpdateStartTime > timeBetweenUpdates){
            ...
            angularVelocity = MathFunctions.angleWrap(worldAngle_rad-lastAngle) / elapsedTime;
